...
import { Send, Baby, Heart, AlertCircle, CheckCircle, Sparkles } from 'lucide-react';
...
export default function BabyGuideApp() {
  ...
  const handleAskQuestion = async (userQuestion) => {
    ...
    try {
      // Call your backend API instead of Claude directly
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-12">
              ...
              <p className="text-gray-500 mb-8 max-w-md">
                From soft spots to sleep schedules, I'm here to help answer your baby care questions with kindness and clarity.
              </p>
                  ...
                  >
                    {msg.type === 'ai' && (
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-medium text-purple-600">Baby Guide</span>
                      </div>
                    )}
